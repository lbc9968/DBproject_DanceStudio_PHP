...
if(isset($_POST["style_id"]) && !empty($_POST["style_id"])){
    ...
    if(empty($name_err) && empty($address_err) && empty($salary_err)){
        ...
        $sql = "UPDATE dance_style SET style_name=? WHERE style_id=?";
    ...
    if(isset($_GET["style_id"]) && !empty(trim($_GET["style_id"]))){
        // Get URL parameter
        $style_id =  trim($_GET["style_id"]);
        
        // Prepare a select statement
        $sql = "SELECT * FROM dance_style WHERE style_id = ?";
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <a href="dance-style.php" class="btn btn-secondary ml-2">Cancel</a>
                    </form>
                </div>
            </div>        
        </div>
